...
use crate::external::idleness::{mock, DisplayServerInterface, IdlenessSetter};
...
async fn test_happy_path() {
    ...
    let setter = iface.get_idleness_setter();
    let port = idleness_effector::spawn(iface.get_idleness_setter());
